#include "project.h"
/*
void vDECODE_PGN_FF14_VECTOR_RS232_STBDTAB( unsigned char ucEngineNum, struct buffer_object *rx_tail )
{
    UInt16 uiData = 0;
    ...
    {
        data_base[db_VECTOR_stbd_trimtab][0].data.flt = ( float )uiData;
