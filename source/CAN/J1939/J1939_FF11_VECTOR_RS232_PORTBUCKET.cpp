...
/*
void vDECODE_PGN_FF11_VECTOR_RS232_PORTBKT( unsigned char ucEngineNum, struct buffer_object *rx_tail )
{
    UInt16 uiData = 0;
    ...
    {
        data_base[db_VECTOR_port_bucket][0].data.flt = ( float )uiData;
