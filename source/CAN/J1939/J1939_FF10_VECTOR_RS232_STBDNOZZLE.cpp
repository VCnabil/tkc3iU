...
/*void vDECODE_PGN_FF10_VECTOR_RS232_STBDNOZ( unsigned char ucEngineNum, struct buffer_object *rx_tail )
{
    UInt16 uiData = 0;
    ...
    {
        data_base[db_VECTOR_stbd_nozzle][0].data.flt = ( float )uiData;
